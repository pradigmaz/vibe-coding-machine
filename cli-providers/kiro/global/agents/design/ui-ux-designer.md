---
name: ui-ux-designer
description: Focuses on user experience, creating intuitive, accessible, and aesthetically pleasing user interfaces. Uses UI/UX Pro Max skill.
...
# Then run the search script
python3 skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard dark mode" --design-system --persist
```
